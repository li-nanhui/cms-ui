<template>
  ...
  <div class="user_list">
    <div class="btns">
      <el-button type="primary" size="small" @click="toAdd" round>添加</el-button>
    </div>
    <el-table :data="users" size="small">
      ...
      <el-table-column label="操作" align="center" width="180">
        <template slot-scope="scope">
          ...
          <el-button type="text" size="small" @click="toEdit(scope.row)">查看/修改</el-button>
...
export default {
  ...
  methods:{
    ...
    deleteHandler(id){
      this.$confirm('此操作将永久删除该用户，请慎重, 是否继续?', '提示', {
